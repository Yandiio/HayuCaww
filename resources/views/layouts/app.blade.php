...
<head>
    ...
    <link rel="icon" type="image/png" href="{{asset('images/3d.png')}}">
  ...
  <div id="app" >
    <nav class="navbar navbar-fixed-top navbar-inverse bg-dark">
      <div class="navbar-header page-scroll">
        ...
        <!-- Branding Image -->
        <a class="navbar-brand bg-light" href="{{url('')}}">
              {{ config('app.name') }}
        </a>
      </div>
          ...
          @else
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true">
               <b>Hi! {{ Auth::user()->name }}</b> <span class="caret"></span>
              </a>
  ...
  <footer class="footer-bs">
    <div class="row">
      <div class="col-md-3 footer-brand animated fadeInLeft">
        ...
        <p>© 2019 {{config('app.name')}}, All rights reserved</p>
      </div>
...
<section style="text-align:center; margin:10px auto;"><p>Copyright <a href="#">{{config('app.name')}} 2019</a></p></section>
