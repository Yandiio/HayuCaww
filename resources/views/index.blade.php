...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="images/bannerr2.jpg" alt="...">
      <div class="carousel-caption">
        <h1>HayuCaww Memberikan Kemudahan dalam memilih Tiket Perjalanan anda</h1>
      </div>
    </div>
    <div class="item">
      <img src="images/bannerr.jpg" alt="...">
      <div class="carousel-caption">
        <h1>HayuCaww Memberikan Harga yang relatif murah dan tersedia berbagai macam pilihan tiket</h1>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        <h2 class="section-heading text-uppercase">Why Booking with HayuCaww?</h2>
      </div>
    </div><br><br>
    ...
    <div class="row text-center">
      <div class="col-md-4">
        ...
        <p class="text-muted">Lebih fleksibel dengan berbagai metode pembayaran dari ATM Transfer, Credit Card, hingga
          Internet Banking.</p>
      </div>

      <div class="col-md-4">
        <img src="{{asset('images/find.png')}}" alt="">
        <h4 class="service-heading">Hasil Pencarian paling Ekstensif</h4>
        <p class="text-muted">Dengan pencarian satu klik, temukan tiket Pesawat dan Kereta ke 100.000 rute di seluruh
          Asia Pasifik dan Eropa untuk penerbangan.</p>
      </div>

      <div class="col-md-4">
        <img src="{{asset('images/shield.png')}}" alt="">
        <h4 class="service-heading">Transaksi Aman Dijamin</h4>
        <p class="text-muted">Keamanan dan privasi transaksi online Anda dilindungi, anda akan Menerima konfirmasi
          instan dan e-ticket langsung di email anda.</p>
      </div>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                <input class="form-control" id="email" type="email" placeholder="Your Email *"
                  data-validation--message="Please enter your email address.">
                <p class="help-block text-danger"></p>
              </div>
              <div class="form-group">
                <input class="form-control" id="phone" type="tel" placeholder="Your Phone *"
                  data-validation--message="Please enter your phone number.">
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <textarea class="form-control" id="message" placeholder="Your Message *"
                  data-validation--message="Please enter a message."></textarea>
                <p class="help-block text-danger"></p>
              </div>
            </div>
